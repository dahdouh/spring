...
import com.karim.Restfull.model.Comparateur;
import com.karim.Restfull.model.ComparateurRequest;
import com.karim.Restfull.model.GetHotelRequest;
import com.karim.Restfull.model.Offre;
import com.karim.Restfull.model.ReservationRequest;
...
//      }
	  ...
	  public String comparateurSubmit(@ModelAttribute("comparateur") ComparateurRequest comparateur, Model model) {
		  ...
		  String uri = "http://localhost:8081/comparateur/"+ville+"/"+dateDebut+"/"+dateFin+"/"+nombrePersonnes+"/"+nombreEtoile;
