...
public class HotelClient extends WebServiceGatewaySupport {
  ...
  public GetHotelResponse getOffresHotel(String login, String password, String dateDebut, String dateFin, int nombrePersonHeberges) {
	    ...
	    GetHotelResponse response = (GetHotelResponse) getWebServiceTemplate().marshalSendAndReceive("https://hotel-webservices.cfapps.io/ws/hotel", request,
  ...
  public ReservationResponse doReservation(String login, String password, String idOffre, Client client) {
	    ...
	    ReservationResponse response = (ReservationResponse) getWebServiceTemplate().marshalSendAndReceive("https://hotel-webservices.cfapps.io/ws/hotel", request,
